-- PostgreSQL 16 schema for the Audit Log Service.
-- UUID values are generated by the application, so no PostgreSQL UUID extension is required.

CREATE SEQUENCE audit_event_sequence START WITH 1 INCREMENT BY 1;

CREATE TABLE audit_event (
    event_id UUID PRIMARY KEY,
    chain_sequence BIGINT NOT NULL DEFAULT nextval('audit_event_sequence') UNIQUE,
